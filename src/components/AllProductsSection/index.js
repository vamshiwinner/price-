...
class AllProductsSection extends Component {
  ...
  onChangeSearch = event => {
    this.setState({titleSearch: event}, this.getProducts)
  }

  onChangeCategory = event => {
    this.setState({category: event}, this.getProducts)
  }

  onChangeRating = event => {
    this.setState({rating: event}, this.getProducts)
  }
